...
(2020,'Fall',40443,'CST 999 - Test Class','dwisneski@csumb.edu')
;

insert into assignment (id, due_date, name, course_id) values 
(1, '2021-09-01', 'db design', 31045),
(2, '2021-09-02', 'requirements', 31045),
(3, '2024-09-01', 'first assignmennt', 40443),
(4, '2024-09-02', 'second assignmennt', 40443)
;
...
('user', 'dwisneski@csumb.edu', '$2a$10$NVM0n8ElaRgg7zWO1CxUdei7vWoPg91Lz2aYavh9.f9q0e4bRadue','USER'),
